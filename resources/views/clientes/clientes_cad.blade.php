                  ...
                  <span class="btn btn-foreground-alternate dropdown-toggle" data-bs-toggle="tooltip"
                    ...
                    <div>
                        <table id="datatableBoxed" class="data-table nowrap hover">
                            <thead>
                            <tr>
                                <th class="text-muted text-small text-uppercase">Nome</th>
                                <th class="text-muted text-small text-uppercase">CPF/CNPJ</th>
                                <th class="text-muted text-small text-uppercase">Celular</th>
                                <th class="text-muted text-small text-uppercase">Plano</th>
                                <th class="text-muted text-small text-uppercase">Situação</th>
