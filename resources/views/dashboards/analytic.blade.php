                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="p mb-0 d-flex align-items-center lh-1-25">Shipped Orders
                                                </div>
                                            </div>
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="p mb-0 d-flex align-items-center lh-1-25">Delivered Orders
                                                </div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="p mb-0 d-flex align-items-center lh-1-25">Pending Orders
                                                </div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="p mb-0 d-flex align-items-center lh-1-25">Unconfirmed
                                                    Orders
                                                </div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                        ...
                        <div class="card sh-13">
                            <div class="card-body py-0 d-flex">
                                <div class="row g-0 d-flex w-100 align-items-center">
                                    <div
                                        class="col sh-6 d-flex flex-column justify-content-center custom-legend-container"></div>
                                    <template class="custom-legend-item">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card sh-13">
                            <div class="card-body py-0 d-flex">
                                <div class="row g-0 d-flex w-100 align-items-center">
                                    <div
                                        class="col sh-7 d-flex flex-column justify-content-center custom-legend-container"></div>
                                    <template class="custom-legend-item">
                                        <div class="text-small text-muted text mt-2"></div>
                                        <div class="cta-3 text-primary value"></div>
                                    </template>
