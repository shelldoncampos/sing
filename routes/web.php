...
use App\Http\Controllers\ControleCliente;
use App\Http\Controllers\SignatureController;
use App\Http\Controllers\PDFController;


Route::view('Contrato', '/contrato');   
Route::get('/gerapdf/{id}', [PDFController::class, 'show']);
Route::get('/', [ControleCliente::class, 'index']);
Route::get('/clientes/create', [ControleCliente::class, 'create']);
Route::get('/clientes/{id}', [ControleCliente::class, 'show']);
Route::post('/clientes', [ControleCliente::class, 'store']);
...
Route::get('/clientes/lista', [ControleCliente::class, 'index']);
...
Route::prefix('Pages')->group(function () {
    ...
    Route::prefix('Miscellaneous')->group(function () {
        ...
        Route::view('Search', [ControleCliente::class,'pages/miscellaneous/search']);
...
Route::prefix('Interface')->group(function () {
    ...
    Route::prefix('Forms')->group(function () {
        ...
        Route::view('Cadastro', 'interface/forms/cadastro');
        Route::prefix('Controls')->group(function () {
            ...
            Route::view('Assinatura', 'interface/forms/controls/assinatura');
    ...
    Route::prefix('Plugins')->group(function () {
        ...
        Route::prefix('Datatables')->group(function () {
            ...
            Route::view('ClientesCadastrados', 'interface/plugins/datatables/clientes_cad');
