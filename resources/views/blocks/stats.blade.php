                            ...
                            <div class="col-auto mb-5">
                                <div class="card hover-border-primary sw-19 sh-30">
                                    <div
                                        ...
                                        <div
                                            class="bg-gradient-2 sw-8 sh-8 rounded-xl d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-auto mb-5">
                                <div class="card sw-19 sh-30 bg-gradient-2">
                                    <div
                                        class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                        <div
                                            class="border border-foreground sw-8 sh-8 rounded-xl d-flex justify-content-center align-items-center">
                                            <i data-cs-icon="mushrooms" class="text-white"></i>
                                        </div>
                                        <div
                                            class="heading text-center mb-0 sh-8 d-flex align-items-center lh-1-25 text-white">
                                            Completed Orders
                                        </div>
                            ...
                            <div class="col-auto mb-5">
                                <div class="card sh-20 sw-20 bg-gradient-2">
                                    <div
                                        ...
                                        <div
                                            class="heading text-center mb-0 sh-4 d-flex align-items-center lh-1 text-white">
                                            Corn
                                        </div>
                            ...
                            <div class="col-12 col-xl-4 mb-5">
                                <div class="card bg-gradient-2">
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        ...
                                        <div class="col">
                                            <div
                                                class="heading mb-0 sh-8 d-flex align-items-center lh-1-25 ps-3 text-white">
                                                Completed Orders
                                            </div>
                                        </div>
                                        <div class="col-auto ps-3">
                            ...
                            <div class="col-12 col-xl-4 mb-5">
                                <div class="card hover-border-primary">
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="p mb-0 sh-5 d-flex align-items-center lh-1-25 ps-3">Completed
                                                Orders
                                            </div>
                                        </div>
                                        <div class="col-auto ps-3">
                            ...
                            <div class="col-12 col-xl-4 mb-5">
                                <div class="card active">
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        <div class="col-auto">
                                            <div
                                                class="sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center border border-primary">
                                                <i data-cs-icon="mushrooms" class="text-primary"></i>
                                            </div>
                                        </div>
                                        <div class="col">
                            ...
                            <div class="col-12 col-xl-4 mb-5">
                                <div class="card bg-gradient-2">
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        <div class="col-auto">
                                            <div
                                                class="border border-foreground sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
                                                <i data-cs-icon="mushrooms" class="text-white"></i>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="p mb-0 sh-5 d-flex align-items-center lh-1-25 ps-3 text-white">
                                                Completed Orders
                                            </div>
                                        </div>
                                        <div class="col-auto ps-3">
                                    ...
                                    <div
                                        ...
                                        <div class="sw-8 sh-8 d-flex justify-content-center align-items-center">
                                            <div role="progressbar"
                                                 ...
                                                 data-trail-color="" aria-valuemax="100" aria-valuenow="75"
                                                 data-show-percent="true" data-hide-all-text="false"
                                                 data-stroke-width="3" data-trail-width="1" data-duration="0"></div>
                                        </div>
                                        <div class="heading text-center mb-0 sh-8 d-flex align-items-center lh-1-25">
                                            Completed Orders
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-0 align-items-center mb-2 sh-6">
                                            ...
                                            <div class="col ps-3">
                                                <div class="row g-0">
                                                    <div class="col">
                                                        <div class="p mb-0 sh-3 d-flex align-items-center lh-1-25">
                                                            Ingredients
                                                        </div>
                                                    </div>
                                                    <div class="col-auto">
                                        ...
                                        <div class="row g-0">
                                            <div
                                                class="col pe-4 d-flex flex-column justify-content-between align-items-end">
                                            ...
                                            <div
                                                class="col-auto d-flex flex-column justify-content-between align-items-end">
                                    ...
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        ...
                                        <div class="col sh-6 ps-3 d-flex flex-column justify-content-center">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div
                                                    class="col text-success d-flex align-items-center justify-content-end">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row g-0 mb-n5 mb-sm-0">
                                            <div
                                                class="col-6 col-sm-3 text-center d-flex justify-content-center align-items-center flex-column mb-4 mb-sm-0">
                                                <div
                                                    class="bg-gradient-2 sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-3">
